...
void MenuViewController::onCreate(SpeedCC::SCDictionary parameters)
{
    ...
    auto ptrNewGameBvr = SC_BVR_GROUP(ptrBackSceneBvr,
                                 SCBehaviorDeliverMessage::create(false,SCMessage::create(kPlaneMsgNewGame)));
...
void GameOverViewController::onCreate(SpeedCC::SCDictionary parameters)
{
    SCViewController::onCreate(parameters);
